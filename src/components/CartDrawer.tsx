        ...
        <div className="w-screen max-w-md bg-white shadow-2xl flex flex-col justify-between border-l border-slate-200">
          ...
          <div className="p-5 border-b border-slate-200 flex items-center justify-between bg-slate-900 text-white">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-extrabold text-base">Carrito de Repuestos Suzuki</h3>
            </div>
            <button
              onClick={onClose}
          ...
          {activeMotorcycle && (
            <div className="bg-emerald-50 border-b border-emerald-200 p-3.5 px-5 flex items-center gap-2 text-emerald-900 text-xs">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-1">
                        ...
                        {onViewPartDetail && (
                          <button
                            ...
                            className="text-slate-400 hover:text-[#E60012] hover:bg-red-50 p-1 rounded transition-colors flex items-center gap-1 text-[10px] font-bold cursor-pointer"
                      ...
                      >
                        <Bike className="w-3 h-3 text-[#E60012] shrink-0" />
                        <span className="truncate">Vehículo: {vehicleLabel}</span>
                      </div>

                      <div className="text-xs font-black text-slate-900 mt-1.5">{formatCurrency(item.part.price)}</div>
          ...
          {cartItems.length > 0 && (
            <div className="p-5 border-t border-slate-200 bg-white space-y-3">
              <div className="flex justify-between items-center text-sm font-black text-slate-900">
                ...
                <span className="text-lg text-[#E60012] font-black">{formatCurrency(total)}</span>
              </div>

              <div className="space-y-2 pt-1">
                <button
                  onClick={onProceedCheckout}
                  className="w-full py-3 bg-[#E60012] hover:bg-red-700 text-white font-extrabold text-xs uppercase tracking-wider rounded-xl transition-colors shadow-md flex items-center justify-center gap-2 cursor-pointer"
                >
                ...
                <a
                  ...
                  className="w-full py-3 bg-[#25D366] hover:bg-emerald-600 text-white font-extrabold text-xs uppercase tracking-wider rounded-xl transition-colors shadow-sm flex items-center justify-center gap-2 cursor-pointer"
                >
