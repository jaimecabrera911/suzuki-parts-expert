  ...
  return (
    <div className={`bg-white rounded-2xl border transition-all duration-300 overflow-hidden flex flex-col justify-between group hover:-translate-y-0.5 ${
      ...
      <div>
        ...
        <div className="relative aspect-4/3 bg-slate-100/80 overflow-hidden cursor-pointer" onClick={() => onOpenDetail(part)}>
          <img
            src={part.image}
            alt={part.name}
        ...
        <div className="p-4 sm:p-5">
          <h3 
            ...
            className="font-bold text-slate-900 text-sm sm:text-base leading-snug line-clamp-2 hover:text-[#E60012] cursor-pointer transition-colors"
          >
            {part.name}
          </h3>
      ...
      <div className="p-4 sm:p-5 pt-3 border-t border-slate-100 mt-2 space-y-3">
        ...
        <div className="flex items-end justify-between gap-2">
          <div>
            <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider block">PRECIO GENUINO</span>
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={() => onOpenDetail(part)}
            className="p-2.5 text-slate-600 hover:text-slate-900 bg-slate-100 hover:bg-slate-200/80 rounded-xl transition-colors shrink-0"
          ...
          <a
            ...
            className="p-2.5 text-emerald-700 bg-emerald-50 hover:bg-emerald-100 border border-emerald-200/80 rounded-xl transition-colors shrink-0 flex items-center justify-center cursor-pointer"
          ...
          {!activeMotorcycle ? (
            <button
              onClick={onOpenGarageModal}
              className="flex-1 py-2.5 px-3 bg-amber-500 hover:bg-amber-600 text-white font-bold text-xs uppercase rounded-xl transition-colors flex items-center justify-center gap-1.5 shadow-xs"
            ...
            <button
              onClick={() => onOpenDetail(part)}
              className="flex-1 py-2.5 px-3 bg-red-100 text-red-800 font-bold text-xs uppercase rounded-xl cursor-not-allowed flex items-center justify-center gap-1.5 border border-red-200"
              title="Producto no compatible con la motocicleta activa"
            >
              <AlertTriangle className="w-4 h-4 text-[#E60012] shrink-0" />
            ...
            <button
              ...
              className="flex-1 py-2.5 px-3 bg-[#E60012] hover:bg-red-700 text-white font-bold text-xs uppercase tracking-wider rounded-xl transition-colors flex items-center justify-center gap-1.5 shadow-xs"
            >
